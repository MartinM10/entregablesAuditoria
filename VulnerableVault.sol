...
contract VulnerableVault { 
    ...
    modifier enoughFunds(uint256 amount) {
        ...
        require((balance[msg.sender] - amount) >= 0, "Amount cannot be unstaked");
    ...
    */
    ...
    function claimRewards() external {	
        uint256 amount;
        // Variable para almacenar el resultado de la llamada a checkPrivilege
        (bool success, bytes memory returndata) = powerseller_nft.call(abi.encodeWithSignature("checkPrivilege(address)", msg.sender));
        
        // Verifica si la llamada fue exitosa y el resultado devuelto es lo esperado
        require(success, "Call to checkPrivilege failed");
